...
/***/ function(module, exports, __webpack_require__) {
	...
	var NinjaGold = function NinjaGold(props) {
	...
	var MoneyMakers = function MoneyMakers(props) {
		{
			var winStatus = true;
			var goldAmt = 0;
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				'button',
				{ type: 'submit', onClick: props.addGold.bind(null, goldAmt, props.building, winStatus) },
				'Find Gold'
			)
		);
	};

	var ActivityLog = function ActivityLog(props) {
		{
			var loggedActivities = [];
			for (var i = 0; i < props.activities.outcomes.length; i++) {
				loggedActivities.push(_react2.default.createElement(
					'p',
					{ className: props.activities.winLoss[i], key: i },
					props.activities.outcomes[i] + " " + new Date()
				));
			}
		}
		return _react2.default.createElement(
	...
	var App = _react2.default.createClass({
		...
		addGold: function addGold(goldAmt, theBuilding, winStatus) {
			if (winStatus === true) {
				this.setState({
		...
		render: function render() {
			return _react2.default.createElement(
				'div',
				{ className: 'container' },
				_react2.default.createElement(NinjaGold, { totalGold: this.state.gold }),
				_react2.default.createElement(MoneyMakers, { building: 'Farm', description: '(Makes 10 - 20 gold)', addGold: this.addGold }),
				_react2.default.createElement(MoneyMakers, { building: 'Cave', description: '(Makes 5 - 10 gold)', addGold: this.addGold }),
				_react2.default.createElement(MoneyMakers, { building: 'House', description: '(Makes 2 - 5 gold)', addGold: this.addGold }),
				_react2.default.createElement(MoneyMakers, { building: 'Casino', description: '(Makes 0 - 50 gold)', addGold: this.addGold }),
				_react2.default.createElement(ActivityLog, { activities: this.state.activities })
			);
		}
	});
